...
What if all we care about is streamflow in August (lets say fish are particularly sensitive to August flow when air temperature are warm)

What are our maximum likelihood estimates of august flow ?

Lets also compare, calibration using all metrics from class and low flow calibration
